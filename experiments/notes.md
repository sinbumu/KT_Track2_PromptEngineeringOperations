...
## 2025-09-08 결과
- 점수: 08_A=0.6742631451, 08_B=0.6649608036, 08_C=0.6707466635
- 결론: 28_C(0.6834) > 06_C(0.6813) > 08_A > 08_C > 08_B. 06_C/28_C가 여전히 우세.

## 2025-09-09 계획(초안)
- 09_A: 06_C 베이스 유지 + 공식 일정 예외를 공시/판결만 허용(보도자료/고시 제외)로 재확인
- 09_B: 06_C 베이스 유지 + 완화 금지 임계치 조정(부정≥3에서만 완화 금지)로 과도 억제 완화
- 공통: 제출 전 offline_eval 전체 수행, pol 우선 확인

## 2025-09-09 가설
- 09_A: 예외 공시/판결 한정이 cert/tense 과대 축소에 유효한지 재확인
- 09_B: 완화 금지 임계치 완화로 pol 손실 회복 기대

## 2025-09-09 추가 가설
- 09_C: 강한 부정/부정≥3 조건의 완화 티어링으로 pol 안정화 기대

## 2025-09-09 결과(추가)
- 점수: 09_A=0.6611311978, 09_B=0.6759093588, 09_C=0.6642092752
- 메모: 09_B > 09_C > 09_A. 완화 임계치=3이 가장 안정적, 티어링은 효과 제한적.

## 2025-09-10 가설
- 10_A: 공식 예외 최소화가 cert/tense 과대 축소에 기여하는지 재검증
- 10_B: 임계=3 유지 + 반등 제외로 pol 안정화 유지 기대

## 프로젝트 종료 요약 추가
- FINAL_SUMMARY.md 생성(최고점/전략/타임라인/교훈/산출물/권고안)
